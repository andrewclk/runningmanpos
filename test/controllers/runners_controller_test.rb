...
class RunnersControllerTest < ActionController::TestCase
  ...
  test "should create runner" do
    assert_difference('Runner.count') do
      post :create, runner: { area_id: @runner.area_id, runner_name: @runner.runner_name, status: @runner.status }
    end
  ...
  test "should update runner" do
    patch :update, id: @runner, runner: { area_id: @runner.area_id, runner_name: @runner.runner_name, status: @runner.status }
    assert_redirected_to runner_path(assigns(:runner))
  end
